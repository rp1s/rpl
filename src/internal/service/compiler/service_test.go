...
`
	...
	assertFileContains(t, schemaPath, "const userSQLSelectStatement = `SELECT")
	assertFileContains(t, schemaPath, "const userSQLInsertStatement = `INSERT INTO")
...
`
	...
	assertFileContains(t, schemaPath, "const playerSQLSelectStatement = `SELECT")
	assertFileContains(t, schemaPath, "const playerSQLInsertStatement = `INSERT INTO")
	assertFileNotContains(t, schemaPath, `\n`)
